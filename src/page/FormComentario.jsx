    ...
    return (
        <div className="FormComentario bg-gray-100 h-full">
            <div className=" flex flex-col border-2 w-50 h-screen">
                ...
                {/* //////////////////////////////////////////// */}
                {/* EScribir la ruta del archivo php dentro de action */}
                {/* Metjod: POST */}
                ...
                <form
                    ...
                    action="./Form.php"
                    method="POST"
                    className="flex shadow-2xl flex-col relative justify-around p-16 bg-white m-auto  w-2/5 h-4/5 border-2 rounded-lg border-red"
                     >
                    
                    <h2 className="text-center font-serif text-4xl text-blue-700">
                        Completa el formulario
                    </h2>

                    <label htmlFor="name" className="labe mt-4">
                        Name
                    </label>

                    <input type="text" name="name" placeholder="Name" className="w-full bg-gray-300 rounded-lg h-10 p-4" />

                    <label htmlFor="email" className="labe mt-4">
                        Email address
                    </label>
                    ...
                    <a href="/" className='m-auto text-center w-full'>
                        Forgot my password
                    </a>
