    ...
    <section id="principal">
      <div class="flex w-8/12 m-auto justify-end h-screen">
        <div className='h-screen m-auto  flex items-start justify-center flex-col min-w-max'>
          ...
          <h1>NEM.<span></span></h1>
          <a href="servicios.jsx" type="button" class="w-1/2 inline-flex items-center justify-center rounded-md border border-transparent bg-gray-800 px-5 py-3 text-base font-medium hover:text-black text-white hover:bg-gray-300">Servicios</a>
        </div>
