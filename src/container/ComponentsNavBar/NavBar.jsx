...
const NavBar = () => {
    ...
    return (
        <nav className="flex  bg-yellow-200 flex-col items-center">
            <div className='flex flex-center max-w-6xl w-full h-20 items-center justify-between flex-wrap  bg-yellow-200  '>
                ...
                <div id='menu' className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ">
                    ...
                    <div onClick={() => setToggleOrders(!toggleOrders)}>
                        <Link to='/CartContainer' className="flex text-sm px-4 py-2 leading-none border-2 rounde rounded-lg text-blue-500 hover:border-blue-500  lg:mt-0">
